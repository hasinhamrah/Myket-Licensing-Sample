...
public class MyketServerManagedPolicy implements Policy {
    ...
    public MyketServerManagedPolicy(Context context, Obfuscator obfuscator) {
        ...
        mLastResponseTime = Long.parseLong(mPreferences.getString(PREF_LAST_RESPONSE_TIME,
                DEFAULT_LAST_RESPONSE_TIME));
        mLastBootTime = Long.parseLong(mPreferences.getString(PREF_LAST_BOOT_TIME,
                DEFAULT_LAST_BOOT_TIME));
    }
    ...
    /**
     * Returns the current time in milliseconds since device was booted
     *
    ...
    private void setLastResponse(int l) {
        ...
        mLastBootTime = currentBootTime();
        mLastResponse = l;
        mPreferences.putString(PREF_LAST_RESPONSE, Integer.toString(l));
        mPreferences.putString(PREF_LAST_RESPONSE_TIME, Long.toString(mLastResponseTime));
        mPreferences.putString(PREF_LAST_BOOT_TIME, Long.toString(mLastBootTime));
    }
